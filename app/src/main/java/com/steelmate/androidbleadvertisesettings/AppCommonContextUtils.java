...
/**
 * created by XuTi on 2019/6/4 10:50
 */
public class AppCommonContextUtils {
    private static final ActivityLifecycleImpl ACTIVITY_LIFECYCLE = new ActivityLifecycleImpl();

    @SuppressLint("StaticFieldLeak")
    private static Application sApplication;

    private AppCommonContextUtils() {
    ...
    public static boolean isActivityAvaible(Context context) {
        if ((context instanceof Activity) && (getActivityList().contains(context)) && !((Activity) context).isFinishing()) {
